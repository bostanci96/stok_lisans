...
!a.sEmptyTable&&(c&&"HenÃ¼z iÃ§erik eklenmedi."===b.sEmptyTable)&&E(a,a,"sZeroRecords","sEmptyTable");!a.sLoadingRecords&&(c&&"Loading..."===b.sLoadingRecords)&&E(a,a,"sZeroRecords","sLoadingRecords");a.sInfoThousands&&(a.sThousands=a.sInfoThousands);(a=a.sDecimal)&&db(a)}function eb(a){A(a,"ordering","bSort");A(a,"orderMulti","bSortMulti");A(a,"orderClasses","bSortClasses");A(a,"orderCellsTop","bSortCellsTop");A(a,"order","aaSorting");A(a,"orderFixed","aaSortingFixed");A(a,"paging","bPaginate");
...
oPaginate:{sFirst:"Başlangıç",sLast:"Sonuncu",sNext:"Sonraki",sPrevious:"Önceki"},sEmptyTable:"Henüz İçerik Girilmedi.",sInfo:"_START_ Sayfada Toplam _TOTAL_ Kayıt",sInfoEmpty:"",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"_MENU_ Kayıt Göster",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Ara:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Herhangi bir sonuÃ§ bulunamadı!"},oSearch:h.extend({},
