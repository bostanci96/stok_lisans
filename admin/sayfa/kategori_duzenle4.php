...
if(isset($_GET["id"])){
	$id = g("id");
	$catControl = $db->prepare("SELECT * FROM databasekategori WHERE kategori_id=:id");
...
function Kategori_Select($tree,$level=0,$selID = null){
	global $db;
	$sorgula = $db->query("SELECT * FROM databasekategori WHERE kategori_ust_id='$tree' and kategori_durum=1 and kat_secenek=1");
	if($sorgula->rowCount()){
	...
	<div class="content-header row">
		<div class="content-header-left col-md-9 col-12 mb-2">
			<div class="row breadcrumbs-top">
				<div class="col-12">
					<h2 class="content-header-title float-left mb-0">Database Kategori Düzenle</h2>
					<div class="breadcrumb-wrapper col-12">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active"><a href="javascript:void(0);">Database Kategori Düzenle</a>
							</li>
						</ol>
					</div>
				</div>
				...
				<div class="col-12">
					<div class="card">
						<div class="card-header">
							<h4 class="card-title">   <p><b><?php echo $catRow["kategori_adi"];?></b> adlı database kategori düzenleniyor.. </p> </h4>
						</div>
						<div class="card-content">
							<div class="card-body">
								<form role="form" id="forms" method="POST" action="ajax.php?p=databasekategori_edit"  enctype="multipart/form-data">
												...
												<div class="tab-pane active" id="home-fill" role="tabpanel" aria-labelledby="home-tab-fill">
													...
													<div class="col-12">
														<div class="form-group row">
															...
															<div class="col-md-10">
																<fieldset class="position-relative has-icon-left">
																<input type="text" id="first-name" class="form-control" name="kategori_desc" value="<?php echo htmlspecialchars($catRow["kategori_desc"]);?>" placeholder="Kategori Desc">
																	<div class="form-control-position">
																		<i class="feather icon-type"></i>
																	</div>
