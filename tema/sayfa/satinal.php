...
if ($par[1]) {
$paket_id = $par[1];
$ayarControl = $db->query("SELECT * FROM paketler WHERE id='$paket_id'");
...
<section id="basic-input">
    ...
    $insert = $db->prepare("INSERT INTO paytr_bildirim SET bildirim_token=?,kisi_id=?,paket_id=?,tutar=?");
    $okinsert = $insert->execute(array($merchant_oid,$uyeRow["uye_id"],$ayarRow["id"],$ayarRow["paket_tutar"]));
