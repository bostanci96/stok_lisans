	...
	<div class="content-header row">
		<div class="content-header-left col-md-9 col-12 mb-2">
			<div class="row breadcrumbs-top">
				<div class="col-12">
					<h2 class="content-header-title float-left mb-0">Hesaplar</h2>
					<div class="breadcrumb-wrapper col-12">
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="<?php echo ADMIN_URL ;?>">Anasayfa</a>
							</li>
							<li class="breadcrumb-item active"><a href="<?php echo ADMIN_URL ;?>index.php?sayfa=hesaplar">Hesaplar</a>
							</li>
						</ol>
					</div>
				</div>
		...
		<section id="data-list-view" class="data-list-view-header">
			...
			<div class="table-responsive">
				<div class="actions action-btns"><div class="dt-buttons btn-group">
					<a href="<?php echo ADMIN_URL?>index.php?sayfa=hesap_ekle" class="btn btn-outline-primary" tabindex="0" aria-controls="DataTables_Table_0"><span><i class="feather icon-plus"></i> Yeni Ekle</span></a> </div></div>
							...
							if($slideQuery->rowCount()){
								foreach($slideQuery as $slideRow){
									...
									<tr>
										...
										<td>
											<a target="_blank" href="<?php echo URL;?>images/katalog/<?php echo $slideRow["fotograf_href"]; ?>">TXT Görüntüle</a>
											
										</td>
										<td><?php echo $slideRow["fotograf_shortDesc"];?></td>
										<td><?php if($slideRow["fotograf_bolum2"]==1){echo "Freepik";}elseif($slideRow["fotograf_bolum2"]==2){echo"Envato";}?></td>
										...
										if($slideRow["fotograf_durum"]==1){ ?>
											...
											<td > <div class="dropdown dropright">
												...
												<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
													...
													<a class="dropdown-item"  onclick="TekSil(<?php echo $slideRow["fotograf_id"];?>);" >Hesap Sil</a>
												</div>
											</div>   
		...
		function durumDegis(slideId){
			$.post('ajax.php?p=foto_durum_degis', {id: slideId}, function (data) {
				if(data=="yasaklama-basarili"){
					sweetAlert({
						title	: "Başarılı",
						text 	: "Hesap başarılı bir şekilde yayından kaldırıldı.",
						type	: "success"
					},
					function(){
						window.location.reload(true);
					...
					sweetAlert({
						title	: "Başarılı",
						text 	: "Hesap başarılı bir şekilde yayınlandı.",
						type	: "success"
					},
					function(){
						window.location.reload(true);
