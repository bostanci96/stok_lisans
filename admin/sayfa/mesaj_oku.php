...
if(isset($_GET["id"])){
	...
	if($kcontrol->rowCount()){
		...
		if ($catRow["iletisim_cevap"]=="") {
			header("Location:".ADMIN_URL. "index.php?sayfa=okunan");		
	...
	<div class="content-header row">
		<div class="content-header-left col-md-9 col-12 mb-2">
			<div class="row breadcrumbs-top">
				<div class="col-12">
					<h2 class="content-header-title float-left mb-0">Mesaj Oku</h2>
					<div class="breadcrumb-wrapper col-12">
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="<?php echo ADMIN_URL ;?>">Anasayfa</a>
							</li>
							<li class="breadcrumb-item"><a href="<?php echo ADMIN_URL ;?>page/okunan.php">Okunan Mesajlar</a>
							</li>
				...
				<div class="col-12">
					<div class="card">
						...
						<div class="card-content">
							...
							<div class="card-body">
								<form role="form" class="form-horizontal"  id="forms" method="POST" action="<?php echo ADMIN_URL;?>ajax.php?p=mesajsil2"  enctype="multipart/form-data">
									...
									<div class="form-body">
										<div class="">
											...
											<ul class="nav nav-tabs nav-fill" id="myTab" role="tablist" style="margin-top: -55px;">
												<li class="nav-link active">
													<a class="nav-link " id="home-tab-fill" data-toggle="tab" href="#home-fill" role="tab" aria-controls="home-fill" aria-selected="true">  <i class="feather icon-file-text"></i> Mesaj Cevap</a>
												</li>
															...
															<div class="form-group row">
																...
																<div class="col-md-10">
																	<fieldset class="position-relative has-icon-left">
																		...
																		<textarea rows="8" type="text" class="form-control" disabled ><?php echo $catRow["iletisim_cevap"];?></textarea>
																		<div class="form-control-position">
																			<i class="fa fa-pencil-square-o"></i>
																		</div>
																	</fieldset>
											...
											<div class="col-md-8 offset-md-4">
												<button type="submit" class="btn btn-danger mr-1 mb-1">Mesajı Sil</button>
											</div>
										</div>
									</div>
								</form>
		...
		$('#forms').ajaxForm({
			...
			success: function(data) {
				if(data=="bos-deger"){
					...
					sweetAlert({
						title	: "Başarılı",
						text    : "Mesaj Başarılı Bir Şekilde Silindi !",
						type	: "success"
					},
					function(){
						window.location = "<?php echo ADMIN_URL ;?>index.php?sayfa=okunan"
					});
					return false;
				}else{
					sweetAlert("Başarısız","Bir Hata Oluştu !","error");
					return false;
				}
			}
		});
