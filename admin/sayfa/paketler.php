	...
	<div class="content-header row">
		<div class="content-header-left col-md-9 col-12 mb-2">
			<div class="row breadcrumbs-top">
				<div class="col-12">
					<h2 class="content-header-title float-left mb-0">Paketler</h2>
					<div class="breadcrumb-wrapper col-12">
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="<?php echo ADMIN_URL ;?>">Anasayfa</a>
							</li>
							<li class="breadcrumb-item active"><a href="index.php?sayfa=paketler">Paketler </a>
							</li>
						</ol>
					</div>
				</div>
				...
				<div class="actions action-btns"><div class="dt-buttons btn-group">
					...
					<table class="table data-list-view">
						...
						<tbody>
							...
							<?php
							$kquery = $db->query("SELECT * FROM paketler order by id desc");
							if($kquery->rowCount()){
									...
									<td>    <?php
										...
										<td > <div class="dropdown dropright">
												...
												<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
													<a class="dropdown-item" href="index.php?sayfa=paket_duzenle&id=<?php echo $kRow["id"];?>">Görüntüle / Düzenle</a>
