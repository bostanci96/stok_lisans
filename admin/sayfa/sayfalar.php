				...
				<div class="actions action-btns"><div class="dt-buttons btn-group">
					...
					<table class="table data-list-view">
						...
						<tbody>
							...
							<?php
							$uyeQuery = $db->query("SELECT * FROM sayfalar WHERE secenekHaber!=1 AND secenekHaber!=88");
							if($uyeQuery->rowCount()){
								foreach($uyeQuery as $uyeRow){
									...
									<tr>
										...
										<td><a target="_blank" href="<?php echo URL."page/". $uyeRow["sayfa_url"];?>">Sayfaya Git </a></td>
