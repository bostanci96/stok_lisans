...
<div class="content-wrapper">
	<div class="content-header row">
		<div class="content-header-left col-md-9 col-12 mb-2">
			<div class="row breadcrumbs-top">
				<div class="col-12">
					<h2 class="content-header-title float-left mb-0">Database Kategori İşlemleri</h2>
					<div class="breadcrumb-wrapper col-12">
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="<?php echo ADMIN_URL ;?>">Anasayfa</a>
							</li>
							<li class="breadcrumb-item active"><a href="index.php?sayfa=kategoriler4">Tüm Database Kategoriler </a>
							</li>
						</ol>
					</div>
				</div>
				...
				<div class="actions action-btns"><div class="dt-buttons btn-group">
					...
					<table class="table data-list-view">
						...
						<tbody>
							...
							<?php
							$kquery = $db->query("SELECT * FROM databasekategori WHERE kat_secenek=1");
							if($kquery->rowCount()){
								...
								<td><img src="<?PHP echo URL;?>images/kategoriler/thumb/<?php echo $kRow["kategori_resim"];?>" style="width:50px"></td>
									...
									<td><a target="_blank" href="<?php echo URL."database/".$kRow["kategori_id"]."_".$kRow["kategori_url"];?>/">Kategoriye Git </a></td>
									<td>    <?php
	...
	<script>
		...
		function TekSil(catId){
			$.post('ajax.php?p=tek_databasecat_sil', {id: catId}, function (data) {
				if(data=="basarili"){
					sweetAlert({
						title	: "Başarılı",
		...
		function durumDegis(catId){
			$.post('ajax.php?p=cat_databasedurum_degis', {id: catId}, function (data) {
