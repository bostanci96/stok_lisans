...
function Kategori_Select($tree,$level=0){
	global $db;
	$sorgula = $db->query("SELECT * FROM haberkategori WHERE kategori_ust_id='$tree' and kategori_durum=1");
	if($sorgula->rowCount()){
			...
			<div class="row breadcrumbs-top">
				<div class="col-12">
					...
					<div class="breadcrumb-wrapper col-12">
						...
						<li class="breadcrumb-item"><a href="index.php?sayfa=sayfalar2">Blog Yazıları</a>
					</li>
