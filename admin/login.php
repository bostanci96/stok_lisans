			...
			<div class="content-body">
				<section class="row flexbox-container">
					<div class="col-xl-8 col-11 d-flex justify-content-center">
						<div class="card bg-authentication rounded-0 mb-0" style="background: #fff!important; width: 100%;">
							<div class="row m-0">
								<div class="col-lg-6 d-lg-block d-none text-center align-self-center px-1 py-0 login100-pic js-tilt" data-tilt style="padding: 3rem !important;"> 
									<img src="<?php echo URL;?>images/<?php echo $ayar["logo"]; ?>" alt="branding logo" >
								</div>
