                ...
                <div class="auth-wrapper auth-cover">
                    <div class="auth-inner row m-0">
                       <a class="brand-logo" href="<?php echo URL; ?>">
                        ...
                        <div class="d-none d-lg-flex col-lg-8 align-items-center p-5" style="background-image: url(<?php echo URL; ?>images/login-v2.svg); background-repeat: no-repeat; background-size: auto; background-position: center;">
