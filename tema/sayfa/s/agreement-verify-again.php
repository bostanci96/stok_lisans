    ...
    <div class="bs-stepper horizontal-wizard-example">
        ...
        <div class="bs-stepper-content">
            ...
            <div id="social-links" class="content active" role="tabpanel" aria-labelledby="social-links-trigger">
                ...
                <form role="form" class="form-horizontal" id="forms" method="POST" action="<?php echo TEMA_URL; ?>ajax.php?p=sozlesmeverify_two"  enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="mb-1">
                                ...
                                <input class="form-control"  name="sozlezme_pdf[]" id="sozlezme_pdf[]" type="file" id="formFile" />
                            </div>
                        </div>
                        ...
                        <div class=" col-md-12">
                            <center>
                            <button type="submit" class="btn btn-primary btn-lg me-1 mt-2"><?php echo $bloklar["sozlesme_input_buton"]; ?></button>
                            </center>
                        </div>
