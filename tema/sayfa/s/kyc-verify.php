        ...
        <div class="bs-stepper horizontal-wizard-example">
            ...
            <div class="bs-stepper-content">
                <div id="account-details" class="content active" role="tabpanel" aria-labelledby="account-details-trigger">
                    ...
                    <form role="form" class="form-horizontal" id="forms" method="POST" action="<?php echo TEMA_URL; ?>ajax.php?p=kycverify"  enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="mb-1 col-md-6">
                                ...
                                <input class="form-control"  name="kimlikpasaport[]" id="kimlikpasaport[]" type="file" id="formFile" />
                            ...
                            <div class="mb-1 col-md-6">
                                ...
                                <input class="form-control"  name="kimlikselfy[]" id="kimlikselfy[]" type="file" id="formFile" />
                               
                            </div>
                            <div class="mb-1 col-md-12">
                                <center>
                                  <button type="submit" class="btn btn-primary btn-lg me-1"><?php echo $bloklar["profile_kimlik_button"]; ?></button>
                                 </center>
                            </div>
                        </div>
                    </form>
 ...
 $(document).ready(function(event) {
    $('#forms').ajaxForm({
        ...
        success: function(data) {
            if (data == "bos-deger") {
                 Swal.fire({
                    title: '<?php echo $bloklar["alert_bosdeger_title"]; ?>',
                    text: '<?php echo $bloklar["alert_bosdeger_desc"]; ?>',
                    icon: 'info',
                    customClass: {
                ...
                return false;
                  ...
                  Swal.fire({
                    title: '<?php echo $bloklar["alert_success_title"]; ?>',
                    text: '<?php echo $bloklar["alert_success_desc"]; ?>',
                    icon: 'success',
                    customClass: {
                ...
                return true;
                  ...
                  Swal.fire({
                    title: '<?php echo $bloklar["alert_eror_title"]; ?>',
                    text: '<?php echo $bloklar["alert_eror_desc"]; ?>',
                    icon: 'eror',
                    customClass: {
