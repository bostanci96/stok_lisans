				...
				<div class="col-12">
					...
					<div class="breadcrumb-wrapper col-12">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active"><a href="javascript:void(0);">Bekleyen Mesajlarım</a>
							</li>
						</ol>
					</div>
				</div>
		...
		<section id="data-list-view" class="data-list-view-header">
			...
			<div class="table-responsive">
				<div class="actions action-btns"><div class="dt-buttons btn-group">
					<a href="index.php?sayfa=okunan" class="btn btn-outline-primary" tabindex="0" aria-controls="DataTables_Table_0"><span><i class="feather icon-plus"></i> Okunanlar</span></a> </div></div>
					<table class="table data-list-view">
						...
						<tbody>
							...
							<?php
							$kquery = $db->query("SELECT * FROM iletisim WHERE iletisim_durum=0  ORDER BY iletisim_id DESC ");
							if($kquery->rowCount()){
