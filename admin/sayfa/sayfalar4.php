	...
	<div class="content-header row">
		<div class="content-header-left col-md-9 col-12 mb-2">
			<div class="row breadcrumbs-top">
				<div class="col-12">
					<h2 class="content-header-title float-left mb-0">Database İşlemleri</h2>
					<div class="breadcrumb-wrapper col-12">
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="<?php echo ADMIN_URL ;?>">Anasayfa</a>
							</li>
							<li class="breadcrumb-item active"><a href="javascript:void(0);">Tüm Database Yazıları </a>
							</li>
						</ol>
					</div>
				</div>
		...
		<section id="data-list-view" class="data-list-view-header">
			...
			<div class="table-responsive">
				<div class="actions action-btns"><div class="dt-buttons btn-group">
					<a href="index.php?sayfa=sayfa_ekle4" class="btn btn-outline-primary" tabindex="0" aria-controls="DataTables_Table_0"><span><i class="feather icon-plus"></i> Yeni Ekle</span></a> </div></div>
					<table class="table data-list-view">
						...
						<tbody>
							...
							<?php
							$uyeQuery = $db->query("SELECT * FROM sayfalar WHERE secenekHaber=88");
							if($uyeQuery->rowCount()){
								foreach($uyeQuery as $uyeRow){
									...
									<tr>
										...
										<td><a target="_blank" href="<?php echo URL."database_page/". $uyeRow["sayfa_url"];?>">Yazıya Git </a></td>
