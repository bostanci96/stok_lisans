	...
	<div class="content-header row">
		<div class="content-header-left col-md-9 col-12 mb-2">
			<div class="row breadcrumbs-top">
				<div class="col-12">
					<h2 class="content-header-title float-left mb-0">PDFler</h2>
					<div class="breadcrumb-wrapper col-12">
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="<?php echo ADMIN_URL ;?>">Anasayfa</a>
							</li>
							<li class="breadcrumb-item active"><a href="<?php echo ADMIN_URL ;?>index.php?sayfa=katalog">PDFler</a>
							</li>
						</ol>
					</div>
				</div>
							...
							if($slideQuery->rowCount()){
								foreach($slideQuery as $slideRow){
									...
									<tr>
										...
										<td>
											<a target="_blank" href="<?php echo URL;?>images/katalog/<?php echo $slideRow["fotograf_href"]; ?>">PDF Görüntüle</a>
		...
		function TekSil(slideId){
			$.post('ajax.php?p=tek_foto_sil', {id: slideId}, function (data) {
				if(data=="basarili"){
					sweetAlert({
						title	: "Başarılı",
						text 	: "PDF başarılı bir şekilde silindi.",
						type	: "success"
					},
					function(){
		...
		function durumDegis(slideId){
			$.post('ajax.php?p=foto_durum_degis', {id: slideId}, function (data) {
				if(data=="yasaklama-basarili"){
					sweetAlert({
						title	: "Başarılı",
						text 	: "PDF başarılı bir şekilde yayından kaldırıldı.",
						type	: "success"
					},
					function(){
						window.location.reload(true);
