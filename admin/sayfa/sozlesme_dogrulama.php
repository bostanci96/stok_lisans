	...
	<div class="content-header row">
		<div class="content-header-left col-md-9 col-12 mb-2">
			<div class="row breadcrumbs-top">
				<div class="col-12">
					<h2 class="content-header-title float-left mb-0">Sözleşme Doğrulama</h2>
					<div class="breadcrumb-wrapper col-12">
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="<?php echo ADMIN_URL ;?>">Anasayfa</a>
							</li>
							<li class="breadcrumb-item active"><a href="index.php?sayfa=sozlesme_dogrulama">Sözleşme Doğrulama</a>
							</li>
						</ol>
					</div>
				</div>
				...
				<div class="actions action-btns"><div class="dt-buttons btn-group">
					...
					<table class="table data-list-view">
						...
						<tbody>
							...
							<?php
							$uyeQuery = $db->query("SELECT * FROM  uyeler  WHERE uye_id!=1 AND uye_kayıt_rutbe=6 OR uye_kayıt_rutbe=8 ");
...
<button onclick="location.href='index.php?sayfa=sozlesme_duzenle&id=<?php echo $uyeRow["uye_id"];?>'"  class="btn btn-danger " type="button" >
											Sözleşme Bilgileri<br> Kontrol Et 
												</button>
